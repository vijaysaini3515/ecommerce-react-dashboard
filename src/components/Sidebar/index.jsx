...
const Sidebar = () => {
  ...
  return (
    <>
        <div className={`sidebar py-2 px-4 h-full ${context.isSideBarOpen === true ? `${context.sideBarWidth /2}%`: 'w-[0px]'} z-52 fixed top-0 left-0 bg-[#fff] border border-[rgba(0,0,0,0.1)]`}>
          ...
          <ul className='mt-4 overflow-y-auto max-h-[80vh]'>
            <li>
              <Link to='/'>
        ...
        <div 
          className='sidebarOverlay pointer-events-auto block sm:hidden fixed top-0 left-0 bg-[rgba(0,0,0,0.5)] w-full h-full z-[50]'
