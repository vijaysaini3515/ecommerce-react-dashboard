  ...
  return (
    <>
      <div className="card p-3   shadow-md sm:rounded-lg bg-white flex items-center justify-between">
        <div>
          <h3 className="text-[18px] font-[600] ">Category List</h3>
        </div>
        ...
        <div>
          <div className="col  flex items-center gap-3 ">
            ...
            <Button onClick={()=>context.setIsOpenPanel({open:true,model:'Add New Category'})} className="btn-blue btn-sm  !text-white  flex items-center gap-1 !normal-case">
              <FaPlus className="text-[14px] font-[600] " /> Add New Category
            </Button>
          </div>
        </div>
      </div>
                      ...
                      <table className="min-w-full  divide-gray-200">
                        <thead>
                          <tr className="border-b border-[rgba(0,0,0,0.8)]">
                            ...
                            <th
                              scope="col"
                              className="px-2 py-3 w-[300px] text-[14px]  text-center  whitespace-nowrap text-xs font-medium text-gray-500 uppercase"
                            >
                              Category Name
                            </th>
                            <th
                        ...
                        <tbody >
                          <tr className="odd:bg-white border-b border-[rgba(0,0,0,0.3)]">
                            ...
                            <th>
                              <span className="font-[500] text-[16px]">Green fossil</span>
                            </th>
