      ...
      <div className="card p-3   shadow-md sm:rounded-lg bg-white flex items-center justify-between">
        ...
        <div>
          <div className="col  flex items-center gap-3 ">
            ...
            <Button onClick={()=>context.setIsOpenPanel({open:true,model:'Add Home Slide'})} className="btn-blue btn-sm  !text-white  flex items-center gap-1 !normal-case">
              <FaPlus className="text-[14px] font-[600] " /> Add Home Banner Slide
            </Button>
          </div>
        </div>
      </div>
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                          <tr>
                            ...
                            <th
                              scope="col"
                              className="px-2 py-3 w-[300px] text-[14px]  text-start  whitespace-nowrap text-xs font-medium text-gray-500 uppercase"
                            >
                              Image
                            </th>
                            <th
                        ...
                        <tbody>
                          <tr className="odd:bg-white border-b border-[rgba(0,0,0,0.8)]">
                            ...
                            <th scope="col" className="px-2 py-3">
                              <div className="flex items-center gap-2 w-[200px]">
                                <div className="img w-full h-[65px] rounded-md over-hidden group">
                          ...
                          <tr className="odd:bg-white border-b border-[rgba(0,0,0,0.8)]">
                            ...
                            <th scope="col" className="px-2 py-3">
                              <div className="flex items-center gap-2 w-[200px]">
                                <div className="img w- h-[65px] rounded-md over-hidden group">
                                  <Link className="" to="/product/9090">
                                    <img
                                      className="w-full rounded-md transition-all group-hover:scale-105 "
                                      src={banner2Img}
